...
func ProtoMessageIsNil() predicate.Property {
	return predicate.Property(sql.FieldIsNull(FieldProtoMessage))
}

// ProtoMessageNotNil applies the NotNil predicate on the "proto_message" field.
func ProtoMessageNotNil() predicate.Property {
	return predicate.Property(sql.FieldNotNull(FieldProtoMessage))
}
