...
func (pq *PropertyQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (pq *PropertyQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (pq *PropertyQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (pq *PropertyQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (pq *PropertyQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (pq *PropertyQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
